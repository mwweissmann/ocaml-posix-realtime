...
(* OASIS_START *)
(* DO NOT EDIT (digest: 8d79fb9b4f609d24b1aafbb80ba93ccb) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_c_sources =
                        ["common.h"; "common.c"; "time.c"; "mqueue.c"];
                      bs_data_files = [];
                      bs_ccopt =
                        [
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for POSIX realtime";
                      doc_authors = [];
                      doc_abstract = None;
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "posix-realtime";
                           FindlibPackage ("result", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                   ...
                   {exec_custom = false; exec_main_is = "test_time.ml"});
               Executable
                 ({
                     cs_name = "test-mqueue";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "test_mqueue.ml"})
            ];
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "\218\233\004\166q\209\214\188\173\207\187\143\158y\020\213";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
