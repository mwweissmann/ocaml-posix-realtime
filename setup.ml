...
(* OASIS_START *)
(* DO NOT EDIT (digest: d101fb8786dcc698e6d23a47f3152f9d) *)
(*
...
let setup_t =
  {
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for POSIX clock and time";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\023\202\184\001\130\193W-.p\131\184m\204\244.";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
